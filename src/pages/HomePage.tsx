...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans antialiased selection:bg-red-600 selection:text-white transition-colors">
      {/* ================= HERO SECTION ================= */}
      <section className="relative overflow-hidden border-b border-zinc-200 dark:border-zinc-800/80 bg-linear-to-b from-zinc-100 via-zinc-50 to-zinc-50 dark:from-zinc-900/60 dark:via-zinc-950 dark:to-zinc-950">
        {/* Efek Ambient Glow / Spotlight di background */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-87.5 bg-red-600/10 dark:bg-red-600/15 blur-[120px] rounded-full pointer-events-none -z-10" />
        <div className="absolute -top-20 right-10 w-96 h-96 bg-purple-600/5 dark:bg-purple-600/10 blur-[130px] rounded-full pointer-events-none -z-10" />

        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-center">
          {/* Badge Label */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 text-xs sm:text-sm font-medium mb-6 backdrop-blur-sm animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
            Katalog TV Show Terlengkap & Terupdate
          </div>

          {/* Headline Utama */}
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-zinc-900 dark:text-white mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-2xl mx-auto mt-16 pt-10 border-t border-zinc-200 dark:border-zinc-800/60 text-zinc-600 dark:text-zinc-400">
            <div>
